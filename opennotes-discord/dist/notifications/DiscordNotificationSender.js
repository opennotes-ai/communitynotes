...
import { NotificationMethod } from './types.js';
...
export class DiscordNotificationSender {
    ...
    async sendNotification(notification, method) {
        try {
    ...
    async sendBatchedNotification(batch, method) {
        try {
    ...
    async sendChannelMention(channelId, userId, embed) {
        try {
...
//# sourceMappingURL=DiscordNotificationSender.js.map