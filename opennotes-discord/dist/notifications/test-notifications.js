...
async function testNotificationSystem() {
    ...
    const notificationIntegration = new NotificationIntegration(notificationService, requestAggregationService, userService);
    try {
        console.log('✅ Services initialized successfully');
        // Test 1: Queue a test notification
        console.log('\n📤 Test 1: Queueing test notification...');
        const testUserId = 'test-user-123';
        const notificationId = await notificationService.queueNotification(testUserId, NotificationType.CONTRIBUTOR_MILESTONE_REACHED, {
