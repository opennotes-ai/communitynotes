...
import { initializeScoringJob, getScoringJob } from './external/backgroundJob.js';
class Application {
    bot;
    apiServer;
    constructor() {
    ...
    async start() {
        try {
            logger.info('Starting Open Notes Discord Bot...', {
            ...
            logger.info('Open Notes Discord Bot started successfully!');
        }
        catch (error) {
    ...
    async stop() {
        logger.info('Stopping Open Notes Discord Bot...');
        try {
            ...
            logger.info('Open Notes Discord Bot stopped successfully');
        }
        catch (error) {
