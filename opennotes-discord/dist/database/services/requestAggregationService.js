...
export class RequestAggregationService {
    async updateAggregation(messageId) {
        try {
    ...
    async getAggregation(messageId) {
        try {
    ...
    async getMessagesNeedingContributorNotification() {
        try {
    ...
    async markContributorsNotified(messageId) {
        try {
    ...
    async shouldNotifyContributors(messageId) {
        try {
    ...
    async getTopRequestedMessages(serverId, limit = 20, hours = 24) {
        try {
...
//# sourceMappingURL=requestAggregationService.js.map