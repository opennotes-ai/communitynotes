...
export class NoteRequestService {
    async createRequest(data) {
        try {
            ...
            const eligibility = await requestorScoringService.isUserEligibleForRequest(data.requestorId, data.serverId);
            ...
            if (existingRequest) {
                ...
                await requestorScoringService.trackEligibleRequest(data.requestorId, data.messageId, data.reason, data.sources);
    ...
    async deactivateRequest(messageId, requestorId) {
        try {
    ...
    async getRequestsForMessage(messageId, activeOnly = true) {
        try {
    ...
    async getUserRequests(requestorId, activeOnly = true, limit = 50) {
        try {
            return await prisma.noteRequest.findMany({
                where: {
                    requestorId,
    ...
    async getRequestCountForMessage(messageId) {
        try {
    ...
    async getRecentRequests(hours = 24, limit = 100) {
        try {
    ...
    async bulkDeactivateForMessage(messageId) {
        try {
    ...
    async getRequestTrends(serverId, days = 7) {
        try {
...
//# sourceMappingURL=noteRequestService.js.map